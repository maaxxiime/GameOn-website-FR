...
form.addEventListener("submit", function validate(e) {
  ...
  if(emailValue.includes('@') && emailValue.includes('.') && emailValue.length >= 6 ) {
  ...
  if(quantityValue >= 0 && quantityValue <= 99 && quantityValue != quantityValue.includes("a") ) {
  ...
  if(locationUnChecked === true || locationDeuxChecked === true || locationTroisChecked === true || locationQuatreChecked === true ||locationCinqChecked === true || locationSixChecked === true) {
  ...
  // if (firstLength <= 1 && lastLength <= 1 && emailValue.includes('@') && emailValue.includes('.') && emailValue.length >= 6 &&
  // birthDateLength == 10 &&) {
